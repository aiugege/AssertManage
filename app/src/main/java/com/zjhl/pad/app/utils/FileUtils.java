...
public class FileUtils {
    ...
    private static String RAR_CONTENTTYPE = "application/x-rar-compressed";
    ...
    public static String writeResponseBodyToDisk(Context context, ResponseBody body, String url) {
        String pathbase = getSDPath()+"/AssetX/";
        makeFolders(pathbase);
        String filename = "";
        String filename2 = "";
        try {
...
//            String path0 = context.getExternalFilesDir(null) + File.separator +filename;
            ...
            if(!isFileExist(path0)) {
                MyLogger.pLog().d("contentType:>>>>" + body.contentType().toString());
                ...
                if (type.equals(APK_CONTENTTYPE)) {
                    ...
                    fileSuffix = ".zip";
                }else if (type.equals(RAR_CONTENTTYPE)) {
                    fileSuffix = ".rar";
                }

//                String path = context.getExternalFilesDir(null) + File.separator + filename2 + fileSuffix;
                String path = pathbase + filename2 + fileSuffix;
                if(StringUtils.isEmpty(fileSuffix)){
                    path = pathbase + filename;
                }
                MyLogger.pLog().e("path=" + path);
