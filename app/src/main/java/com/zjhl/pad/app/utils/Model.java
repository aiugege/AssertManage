...
public class Model {
    ...
    // 第一个listview的文本数据数组
    public  String[] LISTVIEWTXT = new String[] { MyApplication.mMyApplication.getResources().getString(R.string.filtrate_senddate), MyApplication.mMyApplication.getResources().getString(R.string.filtrate_enddate),
