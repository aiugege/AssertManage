 ...
 * @projectname: nnkj
 **/
public class EditInputFilterRate implements InputFilter {
    /**
     * 最大数字
     */
    ...
    public CharSequence filter(CharSequence src, int start, int end,
        ...
        if(!src.toString().equals("")&&!src.toString().equals(".")){
            ...
            if(dold > MAX_VALUE){
//                ToastUtils.showShort("输入的最大金额不能大于"+MAX_VALUE);
                ToastUtils.showShort(MyApplication.mMyApplication.getResources().getString(R.string.toast_filtrate));
