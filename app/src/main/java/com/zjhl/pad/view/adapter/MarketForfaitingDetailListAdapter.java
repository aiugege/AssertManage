 ...
 * | 代码修改:（修改人 - 修改时间）
 **/
public class MarketForfaitingDetailListAdapter extends BaseQuickAdapter<MarketForfaitingOfferListRes.DataBean, BaseViewHolder> implements BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.OnItemChildClickListener {
    //    NestAdapter nestAdapter;
    int positiontrue;
    String myAssets = "0";

    public MarketForfaitingDetailListAdapter(List<MarketForfaitingOfferListRes.DataBean> data,String myAssets) {
