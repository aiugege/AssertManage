 ...
 * | 代码修改:（修改人 - 修改时间）
 **/
public class MarketFactoringDetailListAdapter extends BaseQuickAdapter<MarketForfaitingOfferListRes.DataBean, BaseViewHolder> implements BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.OnItemChildClickListener {
    //    NestAdapter nestAdapter;
    int positiontrue;
    String myAssets = "0";
    public MarketFactoringDetailListAdapter(List<MarketForfaitingOfferListRes.DataBean> data,String myAssets) {
        super(R.layout.item_forfaiting_detail_offer_list, null);
    ...
    protected void convert(BaseViewHolder helper, MarketForfaitingOfferListRes.DataBean item) {
        ...
        helper.setText(R.id.item_forfaiting_detail_offer_list_date, item.getUpdateTime());
        helper.setText(R.id.item_forfaiting_detail_offer_list_rate, item.getDiscountRate());
        helper.setText(R.id.item_forfaiting_detail_offer_list_lable, MyApplication.mMyApplication.getResources().getString(R.string.market_factoring_detail_transferrate));
...
//            helper.setBackgroundColor(R.id.rl_list, mContext.getResources().getColor(R.color.gray));
//            helper.setImageResource(R.id.item_forfaiting_detail_offer_list_im, R.drawable.radiobutton_checked);
//        }else{
            helper.setBackgroundColor(R.id.rl_list, mContext.getResources().getColor(R.color.white));
//            helper.setImageResource(R.id.item_forfaiting_detail_offer_list_im, R.drawable.radiobutton_normal);
//        }
//        if ("107".equals(item.getPriceState())) {
//            helper.setImageResource(R.id.item_forfaiting_detail_offer_list_im, R.drawable.radiobutton_checked);
