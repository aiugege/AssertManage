...
import com.zjhl.pad.moudle.ventity.BaseFilter;
import com.zjhl.pad.view.views.CommonFilterPop;

import java.util.ArrayList;
import java.util.List;

/**
 * @desc: BasePopActivity
 * @version: v1.0
 * @packagename: com.zjhl.pad.view.activity.base
 * @author: pluto
 * @create: 2018/5/3 9:28
 * @projectname: nnkj
 **/
