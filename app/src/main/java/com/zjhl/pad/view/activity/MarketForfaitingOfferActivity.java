 ...
 * @projectname: nnkj
 **/
public class MarketForfaitingOfferActivity extends BaseActivity {
...
//        id = getIntent().getStringExtra("id");
        marketForfaitingDetailRes = (MarketForfaitingDetailRes) getIntent().getSerializableExtra("marketForfaitingDetailRes");
        marketForfaitingOfferTvRate.setText(getString(R.string.market_forfaiting_detail_discount_rate));
        marketForfaitingOfferEvRate.setHint(getString(R.string.hint_issue_forfaiting_buy_discountrate));
...
//        MyLogger.pLog().i("id:" + id);
        MyLogger.pLog().i("marketFactoringDetailRes:" + marketForfaitingDetailRes.toString());
        setData();
...
//                        setData(response.body());
    ...
    public void initView() {
        sureOrCancelDialog = new SureOrCancelDialog(MarketForfaitingOfferActivity.this, new BaseDialog.OnBaseDialogListener() {
            @Override
...
//        marketFactoringDetailRes = marketForfaitingDetailRes1;
        ...
        if (StringUtils.isNullObject(dataBean)) {
            ...
            if (StringUtils.isNullObject(assetsBean)) {
                ...
                marketForfaitingOfferTvNumber.setText(assetsBean.getAssetsNo());
//                marketForfaitingOfferTv2Bank.setText(assetsBean.getOpenFullName());
                ...
                transferRate = assetsBean.getDiscountRate();
                ...
                //设置资产类型1 福费廷 2保理
                marketForfaitingOfferReq.setTradingType("1");
            }
