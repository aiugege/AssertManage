 ...
 **/
public class ReviewOfferSubmitOnSaleListRes extends ResponseBean implements Serializable{
    ...
    public static class DataBean  implements Serializable{
        ...
        public String getPollicitaNo() {
            return pollicitaNo;
        }

        public void setPollicitaNo(String pollicitaNo) {
            this.pollicitaNo = pollicitaNo;
        }
        ...
        public String toString() {
            return "DataBean{" +
                    ...
                    ", pollicitaBackDate='" + pollicitaBackDate + '\'' +
                    ", pollicitaBackEndDate='" + pollicitaBackEndDate + '\'' +
    ...
    @Override
    public String toString() {
        return "ReviewOfferSubmitOnSaleListRes{" +
                "code=" + code +
                ", message='" + message + '\'' +
