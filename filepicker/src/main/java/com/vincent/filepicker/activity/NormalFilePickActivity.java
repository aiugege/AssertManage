...
public class NormalFilePickActivity extends BaseActivity {
    public static final String IS_TAKEN_DONE = "IsTakenDone";
    public static final String IS_TAKEN_HINT = "IsTakenHint";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvdone = getIntent().getStringExtra(IS_TAKEN_DONE);
        tvhint = getIntent().getStringExtra(IS_TAKEN_HINT);
