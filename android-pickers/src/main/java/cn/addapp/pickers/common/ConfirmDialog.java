...
public abstract class ConfirmDialog<V extends View> extends BaseDialog<View> {
    ...
    protected int cancelTextIcon = 0;
    protected CharSequence submitText = "";
    protected int submitTextIcon = 0;
     ...
     * 设置顶部标题栏取消按钮图片
     */
    public void setCancelTextIcon(int cancelTextIcon) {
        if (null != cancelButton) {
//            cancelButton.setText(cancelText);
            cancelButton.setCompoundDrawablesWithIntrinsicBounds(null, null, null, activity.getResources().getDrawable(cancelTextIcon));
        } else {
            this.cancelTextIcon = cancelTextIcon;
        }
    }
     ...
     * 设置顶部标题栏确定按钮图片
     */
    public void setsubmitTextIcon(int submitTextIcon) {
        if (null != submitButton) {
//            Drawable myImage = activity.getResources().getDrawable(submitTextIcon);
//            myImage.setBounds(10, 10, 1000, 1000);
            submitButton.setCompoundDrawablesWithIntrinsicBounds(null, null, null,activity.getResources().getDrawable(submitTextIcon) );
        } else {
            this.submitTextIcon = submitTextIcon;
        }
    }
    ...
    protected View makeHeaderView() {
        ...
        cancelParams.setMargins(0,30,0,0);
        ...
        if (0 != (cancelTextIcon)) {
            cancelButton.setCompoundDrawablesWithIntrinsicBounds(null,
                    activity.getResources().getDrawable(cancelTextIcon), null, null);
        }
        ...
        submitParams.setMargins(0,30,0,0);
        ...
        if (0 != (submitTextIcon)) {
            submitButton.setCompoundDrawablesWithIntrinsicBounds(null,
                    activity.getResources().getDrawable(submitTextIcon), null, null);
        }
